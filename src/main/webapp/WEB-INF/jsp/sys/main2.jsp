        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item layuimini-setting">
                ...
                <dl class="layui-nav-child">
                    ...
                    <dd>
                        <a href="javascript:;" data-iframe-tab="${pageContext.request.contextPath}/sys/editpsw.action" data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
                    </dd>
                    <dd>
        ...
        <div class="layui-tab" lay-filter="layuiminiTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div id="layuiminiHomeTabIframe" class="layui-tab-item layui-show">
                    <iframe width="100%" height="100%" frameborder="0" src="${pageContext.request.contextPath }/sys/welcome.action"></iframe>
                </div>
            </div>
        </div>
    </div>
...
<script>
    layui.use(['element', 'layer', 'layuimini'], function () {
        var $ = layui.jquery,
            ...
            layer = layui.layer;
        layuimini.init('${pageContext.request.contextPath}/api/init2.json');

        $('.login-out').on("click", function () {
            layer.msg('退出登录成功', function () {
                window.location = '${pageContext.request.contextPath}/sys/logout.action';
            });
        });
    });
</script>
