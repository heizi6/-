                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="classes" placeholder="请输入班级"
                               autocomplete="off" readonly="readonly" lay-verify="required" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
...
<script>
    ...
    layui.use(['laydate','jquery', 'layer', 'form', 'table'], function () {
        ...
        tableIns = table.render({
            elem: '#currentTableId',
            url: "${pageContext.request.contextPath}/student/getClassStudent.action",
            method: "POST",
            where: {
                username : null,
                working : null,
