            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="classes"  readonly="readonly" value="${currentUser.classes}"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
...
<script>
    ...
    layui.use(['laydate','jquery', 'layer', 'form', 'table'], function () {
        ...
        tableIns = table.render({
            elem: '#currentTableId',
            url: "${pageContext.request.contextPath}/user/getClassUserList.action",
            method: "POST",
            where: {
                username: null,
                sex: null,
        ...
        function openAddUser() {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    //清空表单数据
                    $("#dataFrm")[0].reset();
                    url = "${pageContext.request.contextPath}/user/addClassUser.action";
                }
            });
        }
