        ...
        <form class="layui-form" lay-filter="dataFrm" id="dataFrm">
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="name" name="username" lay-verify="required" placeholder="请输入用户姓名"
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    <label class="layui-form-label">教工号/学号:</label>
                    <div class="layui-input-inline">
                        <input type="text" id="number" name="number" lay-verify="required" placeholder="请输入教工号/学号"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline" id="role">
                        <input type="radio" name="role" value="1" lay-verify="otherReq" title="管理员">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline" id="status">
                        <input type="radio" name="status" checked="checked" value="0" title="可用">
                        <input type="radio" name="status" value="1" title="停用">
                    </div>
                </div>
            </div>
...
<%--    修改的弹出框--%>
    <div style="display: none;padding: 20px" id="UpdateDiv">
        <form class="layui-form" lay-filter="updataFrm" id="updataFrm">
            <div class="layui-form-item">
                <input type="hidden" name="id" placeholder="用户id：用来方便通过id修改，在页面中并不现实这个" autocomplete="off" class="layui-input">
                <div class="layui-inline">
                    <label class="layui-form-label">用户姓名:</label>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline" >
                    <label class="layui-form-label">班级</label>
                    <div class="layui-input-inline">
                        <input type="text" name="classes" readonly="readonly" placeholder="请输入教工号/学号"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block" style="text-align: center;padding-right: 120px">
                        <button type="button"
                                class="layui-btn layui-btn-normal layui-btn-md layui-icon layui-icon-release layui-btn-radius"
                                lay-filter="Submit"   lay-submit="">提交
                        </button>
                        <button type="reset"
                                class="layui-btn layui-btn-warm layui-btn-md layui-icon layui-icon-refresh layui-btn-radius">
                            重置
    ...
    layui.use(['laydate','jquery', 'layer', 'form', 'table'], function () {
        ...
        tableIns = table.render({
            ...
            cols: [[
                ...
                {field: 'classes', width: 220, title: '班级', sort: true, align: "center"},
                {
                ...
                {field: 'email', width: 240, title: '邮箱', sort: true, align: "center"},
                {
                    field: 'status', width: 165, title: '状态', sort: true, align: "center", templet: function (d) {
                        return d.status == '0' ? '<font color=green>可用</font>' : '<font color=red>停用</font>';
                    }
                },
                ...
                $.ajax({
                    ...
                    success: function (msg) {
                        ...
                        if (msg.code == 1) {
                            ...
                            top.layer.msg("添加失败", {icon: 5, time: 1000});
                        }
        ...
        function openUpdateCustomer(data) {
            mainIndex = layer.open({
                ...
                area: ['750px', '380px'],
                success: function (index) {
                    form.val("updataFrm", data);//把数据放到编辑框
         ...
         */
        function loadCourse() {
            inputObj = $("#baseCourseDiv").find("input");
